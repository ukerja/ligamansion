											...
											<div class="registermain_right2sub4">
												<div class="row">
													<div class="col-md-10 col-9" style="padding-right:0;">
														<input value="0" maxlength="15" oncopy="return false;" onpaste="return false" name="_JumlahWithdraw" type="text" maxlength="20" id="_JumlahWithdraw" class="register_inputform" placeholder="Jumlah Withdraw" autocomplete="off">
